...
function admin_page_label(string $key): string
{
    $labels = [
        ...
        'volunteer' => 'Volunteer',
        'donate' => 'Donate',
        'locationDetailTemplate' => 'Location Detail — master template',
        'locationDetail1' => 'Location Detail 1',
        'locationDetail2' => 'Location Detail 2',
        'locationDetail3' => 'Location Detail 3',
        'programDetailTemplate' => 'Program Detail — master template',
        'programDetail1' => 'Program Detail 1',
        'programDetail2' => 'Program Detail 2',
        'programDetail3' => 'Program Detail 3',
        'programDetail4' => 'Program Detail 4',
    ];
